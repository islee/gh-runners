#!/usr/bin/env bash
# uninstall.sh — remove the "supabase" systemd runners installed by install.sh.
#
...
echo ""
echo "supabase runners uninstalled. If any still show in org → Settings → Actions → Runners,"
